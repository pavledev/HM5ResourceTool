...
namespace FSB
{
    namespace Vorbis
    {
        ...
        OGGOuputStream::OGGOuputStream(int serialNumber, std::ostream& output)
            : output(output)
        {
        ...
        OGGBinaryWriter::OGGBinaryWriter(int serialNumber, HM5ResourceTool::IO::ZBinaryWriter& binaryWriter)
        ...
        {
            binaryWriter.WriteBytes(page.header, page.header_len);
            binaryWriter.WriteBytes(page.body, page.body_len);
        }
    }
}
